...
// Type: App.Core.Entities.Core.DefinicionWorkflow
...
namespace App.Core.Entities.Core
{
  ...
  {
    public DefinicionWorkflow() => this.Workflows = (ICollection<Workflow>) new HashSet<Workflow>();
    ...
    [Range(1.0, 9.22337203685478E+18, ErrorMessage = "Debe ingresar un valor mayor a 0")]
    ...
    public bool PermitirArchivarTarea { get; set; }
    ...
    [Required(ErrorMessage = "Es necesario especificar este dato")]
    [Display(Name = "Requiere observaciones?")]
    public bool RequiereObservacion { get; set; }

    [Display(Name = "Permitir Observaciones al momento de enviar la tarea")]
    public bool PermitirObservacion { get; set; }

    [Required(ErrorMessage = "Es necesario especificar este dato")]
    [Display(Name = "Requiere Derivación?")]
